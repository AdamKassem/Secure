...
class _SurveythanksState extends State<Surveythanks> {
        ...
        builder: (context, snapshotDatabase) {
          if(snapshotDatabase.hasData){
            ...
            return FutureBuilder<String>(
                future: reader(userData.firstName,userData.lastName), // a previously-obtained Future<String> or null
                  ...
                  if (snapshot.hasData) {
                    ...
                    for(String s in responses){
                      if(data.contains(s)){
                        ...
                        docRef.updateData({'responses':FieldValue.arrayRemove([s])});
                      }
                    }
                    return Scaffold(
                        body: Container(
  ...
  Future<String> reader(String firstName, String lastName) async {
    ...
    String webpage = "https://publicrecords.searchsystems.net/search-result.php?fname="+firstName.toLowerCase()
        +"&lname="+lastName.toLowerCase()+"&state=";
