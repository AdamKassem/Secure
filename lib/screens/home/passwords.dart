          ...
          onPressed: () {
            ...
            for(var x=0;x<5;x++){
              if(rate[x]>0.0){
                ...
                docRef.updateData({'passwords':FieldValue.arrayUnion([s])});
              }
            }
            rating = false;
            ...
            child: StreamBuilder(
                    ...
                    while(passwords.length<5){
                      ...
                      while(temp.length<2){
                        ...
                        if(read.contains(t.toString().toLowerCase())){
                          ...
                          DocumentReference docRef = Firestore.instance.collection('userData').document(user.uid);
                          print(t);
                          docRef.updateData({'responses':FieldValue.arrayRemove([t])});
                          items.removeAt(ind);
                          continue;
                        }
                        temp.add(t);
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return new Card( // what the list view returns
                      elevation: 20,
                      child: Container(
                        height: 100.0,
                        child: Row(
...
//                                     padding: EdgeInsets.fromLTRB(0, 2, 0, 0),
                                          children: <Widget>[
                                            Container(
                                              width: 200,
                                              child: Text(
                                                  passwords[index], style: TextStyle(
                                                  fontSize: 15,
